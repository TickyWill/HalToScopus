...
class app_main(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        import HalToScopus_Utils.HTS_InstituteGlobals as ig
        from HalToScopus_GUI.Useful_Functions import font_size
        from HalToScopus_GUI.Useful_Functions import general_properties
        ...
        from HalToScopus_GUI.Useful_Functions import str_size_mm
        ...
        def _get_file(institute_select):
            ...
            sef_str = tk.filedialog.askdirectory(title = dialog_title)
            if sef_str == '':
        ...
        def _set_sef_widget_param(institute_select, inst_sef):
            ...
            sef_entree      = tk.Entry(self, textvariable = sef_val)
        ...
        eff_sef_width = int(gg.REF_ENTRY_NB_CHAR * width_sf_min)

        # Setting font size for sef
        eff_sef_font_size    = font_size(gg.REF_SUB_TITLE_FONT_SIZE, width_sf_min)
        ...
        eff_sef_pos_x_px = mm_to_px(gg.REF_SEF_POS_X_MM * height_sf_mm, gg.PPI)  
        eff_sef_pos_y_px = mm_to_px(gg.REF_SEF_POS_Y_MM * height_sf_mm, gg.PPI)         
        ...
        launch_but_pos_y_px = win_height_px * 0.65         
...
class Page_UpdateScopus(tk.Frame):
    ...
    def __init__(self, parent, controller, container_button, institute, haltoscopus_path):
        ...
        # Local imports
        import HalToScopus_GUI.GUI_Globals as gg
        from HalToScopus_GUI.Page_UpdateScopus import create_consolidate_scopus
        from HalToScopus_GUI.Useful_Functions import font_size 
        from HalToScopus_GUI.Useful_Functions import mm_to_px
        from HalToScopus_GUI.Useful_Functions import root_properties   
