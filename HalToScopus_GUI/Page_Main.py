...
class app_main(tk.Tk):
    ...
    def __init__(self):
        ...
        app_main.pages = (Page_UpdateScopus,)
        ...
        eff_sef_width = int(gg.REF_ENTRY_NB_CHAR * app_main.width_sf_min)

        # Setting font size for sef
        eff_sef_font_size    = font_size(gg.REF_SUB_TITLE_FONT_SIZE, app_main.width_sf_min)
        ...
        eff_sef_pos_x_px = mm_to_px(gg.REF_SEF_POS_X_MM * app_main.height_sf_mm, gg.PPI)  
        eff_sef_pos_y_px = mm_to_px(gg.REF_SEF_POS_Y_MM * app_main.height_sf_mm, gg.PPI)         
        ...
        launch_but_pos_y_px = app_main.win_height_px * 0.65         
